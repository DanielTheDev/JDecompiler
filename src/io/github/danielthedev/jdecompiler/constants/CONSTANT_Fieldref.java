...
public class CONSTANT_Fieldref extends Constant implements ReferenceLink {
	...
	public CONSTANT_Fieldref(ClassInputStream in) throws IOException {
		super(TAG);
	...
	public String toString() {
		return "CONSTANT_Fieldref [classIndex=" + classIndex + ", nameAndTypeIndex=" + nameAndTypeIndex + "]";
	}
