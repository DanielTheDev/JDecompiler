...
public class CONSTANT_Methodref extends Constant implements ReferenceLink {
	...
	public CONSTANT_Methodref(ClassInputStream in) throws IOException {
		super(TAG);
	...
	public String toString() {
		return "CONSTANT_Methodref [classIndex=" + classIndex + ", nameAndTypeIndex=" + nameAndTypeIndex + "]";
	}
